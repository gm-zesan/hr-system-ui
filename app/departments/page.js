...
export default async function DepartmentsPage({ searchParams }) {
    ...
    try {
        departmentsData = await getDepartments(page, limit, search);
    } catch (error) {
        console.error("Failed to fetch departments from API:", error.message);
    ...
    return (
        <>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-sm text-yellow-700 mt-1">
                                Unable to connect to the backend API. Error: {apiError}
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <DepartmentsClient
                ...
                totalPages={departmentsData?.pages || 1}
