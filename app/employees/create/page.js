                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        onChange={(e) => handleInputChange("employeeTags", e.target.value)}
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <select
                            ...
                            onChange={(e) => handleInputChange("attendanceManager", e.target.value)}
                            className="w-full px-4 py-2.5 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none"
                          >
                            <option value="">Select an option</option>
                          </select>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => handleInputChange("privateCarPlate", e.target.value)}
                          className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        />
                      </div>
                    </div>
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            onChange={(e) => handleInputChange("distanceHomeToWork", e.target.value)}
                            className="w-full px-4 py-2.5 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          />
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            onChange={(e) => handleInputChange("kmHomeToWork", e.target.value)}
                            className="w-full px-4 py-2.5 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          />
                          <span className="absolute right-4 top-1/2 -translate-y-1/2 text-sm text-gray-500">
                            km
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <select
                          ...
                          onChange={(e) => handleInputChange("citizenshipState", e.target.value)}
                          className="w-full px-4 py-2.5 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none"
                        >
                          <option value="">Select an option</option>
                        </select>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => handleInputChange("ssnNo", e.target.value)}
                        className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                      />
                    </div>
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-2 gap-8">
                      <div>
                        ...
                        <button
                          onClick={() =>
                            handleInputChange("activeEmployee", !formData.activeEmployee)
                          }
                          className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                            formData.activeEmployee ? "bg-blue-600" : "bg-gray-300"
                          }`}
                        >
                          <span
                            className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                              formData.activeEmployee ? "translate-x-6" : "translate-x-1"
                            }`}
                          />
                        </button>
                      </div>
                      <div>
                        ...
                        <button
                          ...
                          className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                            formData.flexibleWorkArrangement ? "bg-blue-600" : "bg-gray-300"
                          }`}
                        >
                          <span
                            className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                    ...
                    <div className="grid grid-cols-2 gap-8">
                      <div>
                        ...
                        <button
                          ...
                          className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                            formData.fullyFlexibleSchedule ? "bg-blue-600" : "bg-gray-300"
                          }`}
                        >
                          <span
                            className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
