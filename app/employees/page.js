                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="bg-gray-50 border-b border-gray-200">
                        ...
                        <th className="p-2 text-left font-semibold text-sm text-gray-700">Job Position</th>
                        <th className="p-2 text-left font-semibold text-sm text-gray-700">Email</th>
                        <th className="p-2 text-left font-semibold text-sm text-gray-700">Phone</th>
                        <th className="p-2 text-left font-semibold text-sm text-gray-700">Department</th>
