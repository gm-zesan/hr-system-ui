...
export default function ManageSkillsPage({ params }) {
    ...
    useEffect(() => {
        function handleClickOutside(event) {
            ...
            if (
                skillLevelDropdownRef.current &&
                !skillLevelDropdownRef.current.contains(event.target)
            ) {
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative" ref={skillDropdownRef}>
                                            ...
                                            >
                                                <span
                                                    className={`text-sm ${formData.skill ? "text-gray-900" : "text-gray-400"}`}
                                                >
                                                    {formData.skill || "Select an option"}
                                                </span>
                                                <ChevronDown
                                                    className={`w-5 h-5 text-gray-400 transition-transform ${showSkillDropdown ? "rotate-180" : ""}`}
                                                />
                                            </button>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative" ref={skillLevelDropdownRef}>
                                            ...
                                            >
                                                <span
                                                    className={`text-sm ${formData.skillLevel ? "text-gray-900" : "text-gray-400"}`}
                                                >
                                                    {formData.skillLevel || "Select an option"}
                                                </span>
                                                <ChevronDown
                                                    className={`w-5 h-5 text-gray-400 transition-transform ${showSkillLevelDropdown ? "rotate-180" : ""}`}
                                                />
                                            </button>
