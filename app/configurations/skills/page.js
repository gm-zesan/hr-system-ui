...
export default async function SkillsPage({ searchParams }) {
    ...
    try {
        skillsData = await getSkills(page, limit, search);
    } catch (error) {
        console.error("Failed to fetch skills from API:", error.message);
        ...
        <>
            ...
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-gray-600 mt-1">Manage employee skills</p>
                </div>
                <Link
                    href="/configurations/skills/create"
