...
export default function TagDetailsClient({ tag, onDelete }) {
                ...
                <div className="mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <p className="text-base text-gray-900">{tag.name}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-base text-gray-900">{tag.code || "-"}</p>
                        </div>
                ...
                <div className="pt-6 border-t border-gray-200">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p className="text-base text-gray-900">
                                {tag.updated_at ? new Date(tag.updated_at).toLocaleString() : "-"}
                            </p>
                        </div>
                    </div>
                </div>
