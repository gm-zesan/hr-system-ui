    ...
    <>
      ...
      <div className="mb-6 flex justify-center">
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm inline-flex p-2">
          <TabLink href={`/configurations/job_titles/${id}`} label="View" isActive={isViewActive} />
          <TabLink href={`/configurations/job_titles/${id}/edit`} label="Edit" isActive={isEditActive} />
        </div>
      </div>
