  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div>
          <label className="block text-sm font-medium text-gray-500 mb-1">Job Position ID</label>
      ...
      {jobTitle.description && (
        <div>
          ...
          <p className="text-base text-gray-900 whitespace-pre-wrap">{jobTitle.description}</p>
        </div>
      )}
    </div>
  );
