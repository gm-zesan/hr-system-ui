...
export default function SkillTypeDetailsClient({ skillType, onDelete }) {
                ...
                <div className="mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <p className="text-base text-gray-900">{skillType.name}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-base text-gray-900">{skillType.code || "-"}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                ></div>
                                <span className="text-base text-gray-900">{skillType.color}</span>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-base text-gray-900">{skillType.sequence}</p>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <p className="text-base text-gray-900">
                                {skillType.created_at
                                    ? new Date(skillType.created_at).toLocaleString()
                                    : "-"}
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-base text-gray-900">
                                {skillType.updated_at
                                    ? new Date(skillType.updated_at).toLocaleString()
                                    : "-"}
                            </p>
                        </div>
                    </div>
                    ...
                    >
                        <div className="p-6">
                            ...
                            <p className="text-gray-600 mb-6">
                                ...
                                <span className="font-semibold">{skillType.name}</span>? This action
                                cannot be undone.
                            </p>
